...
|----|-------|--------|---------|------|----------|
| WD-01 | Close engine.clustering + engine.in-process-database-engine gaps | COMPLETE | engine | 0 | — |
| WD-02 | Close query.index-types + query.query-executor gaps | COMPLETE | query | 0 | — |
