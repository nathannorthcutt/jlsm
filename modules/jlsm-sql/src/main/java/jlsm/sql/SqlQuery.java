 ...
 */
// @spec query.sql-query-support.R79,R80,R81,R82 — immutable record; null-reject all components; defensively copy lists;
...
public record SqlQuery(Optional<Predicate> predicate, List<String> projections,
     ...
     */
    // @spec query.sql-query-support.R83 — BindMarker implements Comparable<BindMarker> comparing index values
     ...
     */
    // @spec query.sql-query-support.R84 — stores field, parameterIndex, metric, ascending (ORDER BY direction)
