 ...
 *
 * <p>
 * Contract: Immutable value type attached to query results from partitioned tables. Tracks which
 * partitions were unavailable during query execution, allowing callers to determine whether the
