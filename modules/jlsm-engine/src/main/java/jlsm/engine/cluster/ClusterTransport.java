 ...
 *
 * @spec engine.clustering.R27 — SPI with send (one-way), request (future response),
 *       registerHandler (by message type)
 ...
 * @spec engine.clustering.R30 — handler registration keyed by message type; re-registration replaces atomically
 */
