 ...
 * @spec engine.clustering.R13 — state transitions: ALIVE↔SUSPECTED, SUSPECTED→DEAD; DEAD is terminal
 *       (a rejoining dead node must be treated as a new member with higher incarnation)
 */
