...
/**
 * Subclass of {@link KmsTransientException} surfaced when the KMS rejects a request
 * because the caller is over its rate limit. Kept as a distinct type so observability
 * tooling can count and surface throttling separately from generic transient failures.
 *
