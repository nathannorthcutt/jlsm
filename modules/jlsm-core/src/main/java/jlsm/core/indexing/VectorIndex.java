...
public sealed interface VectorIndex<D> extends Closeable
     ...
     */
    // @spec query.vector-index.R1,R2,R3,R4,R5,R6 — factory SPI that bridges jlsm-core and
    // jlsm-vector
     ...
     */
    // @spec vector.float16-vector-support.R23 — document re-indexing graph-quality degradation in
    // public API
     ...
     */
    // @spec vector.float16-vector-support.R2 — precision is queryable after construction and never
    // null
    // @spec vector.float16-vector-support.R4 — precision is chosen at build time and does not
     ...
     * @param <D> the document ID type
     */
    // @spec vector.float16-vector-support.R25,R25a — SearchResult accepts Infinity scores; Infinity
    // exclusion is
