 ...
 *
 * <p>
 * <b>Pipeline position</b>: Runs as a background process, periodically inspecting the level
 ...
 * {@link jlsm.core.model.SequenceNumber}: the entry with the highest sequence number for a given
 * key survives. {@link jlsm.core.model.Entry.Delete} tombstones are dropped only when the
 * compaction reaches the bottom level and no earlier copies can exist.</li>
...
public interface Compactor {
     ...
     *
     * <p>
     * The caller must remove the source SSTables from the manifest and add the returned output
