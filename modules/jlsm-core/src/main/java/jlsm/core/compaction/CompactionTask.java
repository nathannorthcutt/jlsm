 ...
 *
 * <p>
 * <b>Pipeline position</b>: Produced by {@link Compactor#selectCompaction} and consumed by
 ...
 */
public record CompactionTask(List<SSTableMetadata> sourceSSTables, Level sourceLevel,
        Level targetLevel) {
    public CompactionTask {
        ...
        if (targetLevel.index() < sourceLevel.index()) {
            throw new IllegalArgumentException("targetLevel (%d) must be >= sourceLevel (%d)"
