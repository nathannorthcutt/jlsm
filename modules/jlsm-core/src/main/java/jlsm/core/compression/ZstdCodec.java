 ...
 */
// @spec F18.R7,R7a — tiered detection + fixed codec ID at class-load time
// @spec F18.R17a — dict-bound codec: CDict/DDict in shared Arena, AutoCloseable
// @spec F18.R17b — closed codec throws ISE on compress/decompress
// @spec F18.R17c — no long-lived resources for plain (no-dict) codecs
// @spec F17.R41,R42 — dictionary bytes immutable, safe for concurrent use
final class ZstdCodec implements CompressionCodec, AutoCloseable {
     ...
     */
    // @spec F18.R2 — level validated at construction, valid range 1..22
    ...
    // @spec F18.R3 — native ZSTD_compressBound when Tier 1, conservative default otherwise
    // @spec F18.R3a — overflow guard: IAE if computed bound exceeds int range
    @Override
    ...
    // @spec F18.R26 — Tier-1 downcall failure produces UncheckedIOException, no silent fallback
     ...
     */
    // @spec F18.R28 — decompression errors include ZSTD_getErrorName in the message
