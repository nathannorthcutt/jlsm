 ...
 *      R15-R17</a>
 */
// @spec compression.zstd-dictionary.R15 — trainer: addSample, train(maxDictBytes), static
// isAvailable()
// @spec compression.zstd-dictionary.R15a — samples concatenated into contiguous region with
// parallel size array
// @spec compression.zstd-dictionary.R16 — train() invokes native ZDICT_trainFromBuffer, validates
// [256, 1 MiB]
// @spec compression.zstd-dictionary.R17 — at least one sample required; train() with zero samples
// throws ISE
