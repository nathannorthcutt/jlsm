...
final class ZstdNativeBindings {
    ...
    static {
        ...
        try {
            ...
            // Native detection failed — fall through to Tier 2 or 3
            // Tier 2 (PURE_JAVA_DECOMPRESSOR) is not yet implemented, so go to Tier 3
            detectedTier = Tier.DEFLATE_FALLBACK;
        }
