 ...
 *
 * <p>
 * <b>Pipeline position</b>: Used by the Compactor to select which SSTables to merge and to decide
 * where the output SSTables are placed. L0 receives fresh flushes from the MemTable; compaction
 * moves data toward higher-indexed levels.
 *
 * <p>
 * <b>Key contracts</b>:
 * <ul>
 * <li>{@link #L0} is the landing zone for MemTable flushes; SSTables at L0 may have overlapping key
 * ranges.</li>
 * <li>Levels with {@code index > 0} (L1 and beyond) hold non-overlapping key ranges within a level,
 * as enforced by leveled compaction strategies.</li>
