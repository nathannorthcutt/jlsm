 ...
 * @spec serialization.simd-jsonl.R34 — error handler for skipped lines
 * @spec serialization.simd-jsonl.R35 — AutoCloseable, closes underlying stream
 * @spec serialization.simd-jsonl.R53 — stream() callable at most once
 * @spec serialization.simd-jsonl.R54 — close() releases all internal resources
 */
