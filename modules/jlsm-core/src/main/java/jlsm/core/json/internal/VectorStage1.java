 ...
 *
 * @spec serialization.simd-jsonl.R20 — Tier 2: Vector API character classification
 * @spec serialization.simd-jsonl.R23 — isolated class, loaded only during detection
 * @spec serialization.simd-jsonl.R49 — carries backslash-parity across block boundaries
 */
