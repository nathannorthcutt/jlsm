...
public final class WalRecord {
    ...
    // @spec wal.compression.R1 — flags byte after frame length (bit 0 = compressed)
    // @spec wal.compression.R2 — compressed header: codec ID (1) + uncompressed size (4)
    // @spec wal.compression.R3 — uncompressed: no header, payload follows flags
    // @spec wal.compression.R4 — CRC32 over uncompressed payload
    // @spec wal.compression.R5 — frame length includes flags + header + payload + CRC
    // @spec wal.compression.R6 — all fields use byteAlignment(1), big-endian
    /**
    ...
    // @spec wal.compression.R7 — old-format detection
    // @spec wal.compression.R13 — recovery codec map from codec set
    // @spec wal.compression.R14 — mixed compressed/uncompressed records
    // @spec wal.compression.R15 — unknown codec ID throws IOException
    // @spec wal.compression.R16 — decompression failure treated as corrupt, skip
    // @spec wal.compression.R17 — CRC verification after decompression
    /**
