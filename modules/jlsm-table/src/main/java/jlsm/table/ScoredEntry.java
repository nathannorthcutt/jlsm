 ...
 */
// @spec partitioning.table-partitioning.R22 — public record in jlsm.table with key/document/score
// components
public record ScoredEntry<K>(K key, JlsmDocument document, double score) {

    // @spec partitioning.table-partitioning.R23,R24,R25 — null key→NPE (R23); null document→NPE
    // (R24); NaN score→IAE (R25)
    public ScoredEntry {
