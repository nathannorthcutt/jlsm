...
class VectorFieldTypeAdversarialTest {
     ...
     *
     * @spec schema.document-construction.R30 — of() defensively clones float[] for
     *       VectorType(FLOAT32)
     */
    @Test
     ...
     *
     * @spec schema.document-construction.R30 — of() defensively clones short[] for
     *       VectorType(FLOAT16)
     */
    @Test
     ...
     *
     * @spec schema.document-construction.R27 — FLOAT16 finiteness check rejects NaN (0x7C00
     *       exponent mask)
     */
    @Test
     ...
     *
     * @spec vector.field-type.R17 — non-null similarityFunction rejected when indexType is not
     *       VECTOR
     */
    @Test
     ...
     *
     * @spec schema.document-construction.R27 — non-finite vector rejection at construction prevents
     *       bad JSON round-trip
     */
    @Test
     ...
     *
     * @spec vector.field-type.R27,R30,R33 — encode/decode FLOAT32 preserves bit patterns across
     *       boundary values
     */
    @Test
     ...
     *
     * @spec vector.field-type.R28,R31,R34 — encode/decode FLOAT16 preserves bit patterns across
     *       boundary values
     */
    @Test
