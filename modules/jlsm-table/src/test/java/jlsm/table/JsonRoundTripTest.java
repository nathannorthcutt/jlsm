...
class JsonRoundTripTest {
    ...
    // @spec schema.document-serialization.R1,R3 — JSON round-trip for all primitive types
    @Test
    ...
    // @spec schema.document-serialization.R1,R3 — JSON round-trip preserves escaped characters
    @Test
    ...
    // @spec schema.document-construction.R28 — JSON round-trip preserves nested ObjectType
    // @spec schema.document-serialization.R1,R3 — JSON round-trip preserves nested ObjectType
    @Test
    ...
    // @spec schema.document-construction.R24 — JSON round-trip preserves ArrayType of primitives
    // @spec schema.document-serialization.R1,R3 — JSON round-trip preserves ArrayType of primitives
    @Test
    ...
    // @spec schema.document-construction.R24 — JSON round-trip preserves ArrayType of strings
    // @spec schema.document-serialization.R1,R3 — JSON round-trip preserves ArrayType of strings
    @Test
    ...
    // @spec schema.document-serialization.R3 — fromJson rejects malformed JSON as IAE
    @Test
    ...
    // @spec schema.document-construction.R29 — fromJson surfaces type mismatches as IAE
    // @spec schema.document-serialization.R3 — fromJson surfaces type mismatches as IAE
    @Test
