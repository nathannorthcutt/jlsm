...
class RangeMapAdversarialTest {
     ...
     */
    // @spec partitioning.table-partitioning.R34 — inverted range returns empty list
    @Test
     ...
     */
    // @spec partitioning.table-partitioning.R34 — empty range (from == to) returns empty list
    @ Test
