---
{
  ...
  "status": "ACTIVE",
  "state": "APPROVED",
  "domains": ["encryption", "storage"],
  "requires": ["F41", "F17"],
  "invalidates": [],
  "amends": null,
  "amended_by": null,
  "decision_refs": ["wal-entry-encryption"],
  "kb_refs": ["systems/security/wal-encryption-approaches", "systems/security/encryption-key-rotation-patterns", "systems/security/jvm-key-handling-patterns"],
  "open_obligations": []
}
---
