---
{
  ...
  "amends": null,
  "amended_by": null,
  "decision_refs": ["scan-lease-gc-watermark", "scatter-backpressure"],
  "kb_refs": [
    "distributed-systems/query-execution/distributed-scan-cursors"
  ],
  "open_obligations": ["OB-F44-01: Lease message types (LeaseRequest, LeaseRenewRequest, LeaseReleaseRequest) must be registered in the F19 transport framing protocol message type taxonomy. Deferred pending transport layer extension mechanism."]
}
---

# F44 — Scan Lease GC Watermark
