---
{
  ...
  "status": "ACTIVE",
  "state": "DRAFT",
  "domains": ["cluster-membership"],
  "requires": [],
  "invalidates": [],
  "decision_refs": ["continuous-rediscovery", "discovery-spi-design"],
  "kb_refs": ["distributed-systems/cluster-membership/service-discovery-patterns"],
  "open_obligations": []
}
---

# F22 — Continuous Rediscovery
