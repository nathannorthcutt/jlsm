---
{
  ...
  "domains": ["storage"],
  "requires": ["F09"],
  "invalidates": ["F09.R8", "F09.R9", "F09.R15", "F09.R43", "F09.R44"],
  "amends": null,
  "amended_by": null,
  "decision_refs": ["block-cache-block-size-interaction", "cross-stripe-eviction"],
  "kb_refs": ["data-structures/caching/concurrent-cache-eviction-strategies"],
  "open_obligations": []
}
---

# F25 — Byte-Budget Block Cache
