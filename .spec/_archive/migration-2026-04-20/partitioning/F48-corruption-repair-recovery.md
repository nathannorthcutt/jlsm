---
{
  ...
  "status": "ACTIVE",
  "state": "APPROVED",
  "domains": ["partitioning", "storage"],
  "requires": ["F26", "F32"],
  "invalidates": [],
  "amends": null,
  "amended_by": null,
  "decision_refs": ["corruption-repair-recovery", "per-block-checksums", "sstable-end-to-end-integrity"],
  "kb_refs": [
...
# F48 — Corruption Repair and Recovery
