---
{
  ...
  "requires": ["F16"],
  "invalidates": ["F16.R16", "F16.R17"],
  "amends": null,
  "amended_by": null,
  "decision_refs": ["sstable-end-to-end-integrity", "per-block-checksums"],
  "kb_refs": ["systems/database-engines/corruption-detection-repair"],
  "open_obligations": []
}
---

# F26 — SSTable End-to-End Integrity
